...
return [
    ...
    'settings.delete' => __('Delete Settings'),

    'reports.view' => __('View Reports'),
    'reports.generate' => __('Generate Reports'),

    'tags.view' => __('View Tags'),
    'tags.create' => __('Create Tags'),
    'tags.update' => __('Update Tags'),
    'tags.delete' => __('Delete Tags'),
];
